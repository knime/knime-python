...
class Builder(object):
    ...
    #custom method
    def CreateByteArray(self, s):
        """CreateByteArray writes a bytearray as a vector."""
        ...
        if isinstance(s, compat.binary_types):
            x = s
        else:
            raise TypeError("non-byte type passed to CreateByteArray")

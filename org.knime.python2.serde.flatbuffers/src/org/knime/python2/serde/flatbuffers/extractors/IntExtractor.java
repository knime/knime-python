...
/**
 * Extracts Cells from a IntColumn.
 *
 * @author Clemens von Schwerin, KNIME GmbH, Konstanz, Germany
 */
public class IntExtractor implements VectorExtractor {

    private IntColumn m_colVec;
     ...
     */
    public IntExtractor(final IntColumn colVec, final SerializationOptions opts) {
        m_colVec = colVec;

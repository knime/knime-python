 ...
 */
public class LongListExtractor implements VectorExtractor {
     ...
     */
    public LongListExtractor(final LongCollectionColumn colVec) {
        m_colVec = colVec;
    }
    ...
    public Cell extract() {
        ...
        LongBuffer buff = cell.valueAsByteBuffer().asLongBuffer();

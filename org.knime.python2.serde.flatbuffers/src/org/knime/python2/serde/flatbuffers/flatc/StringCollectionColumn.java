...
public final class StringCollectionColumn extends Table {
  public static StringCollectionColumn getRootAsStringCollectionColumn(final ByteBuffer _bb) { return getRootAsStringCollectionColumn(_bb, new StringCollectionColumn()); }
  public static StringCollectionColumn getRootAsStringCollectionColumn(final ByteBuffer _bb, final StringCollectionColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(final int _i, final ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public StringCollectionColumn __assign(final int _i, final ByteBuffer _bb) { __init(_i, _bb); return this; }

  public StringCollectionCell values(final int j) { return values(new StringCollectionCell(), j); }
  public StringCollectionCell values(final StringCollectionCell obj, final int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static int createStringCollectionColumn(final FlatBufferBuilder builder,
  ...
  public static void startStringCollectionColumn(final FlatBufferBuilder builder) { builder.startObject(2); }

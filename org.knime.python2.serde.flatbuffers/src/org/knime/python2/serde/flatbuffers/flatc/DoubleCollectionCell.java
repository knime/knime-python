...
public final class DoubleCollectionCell extends Table {
    public static DoubleCollectionCell getRootAsDoubleCollectionCell(final ByteBuffer _bb) {
        return getRootAsDoubleCollectionCell(_bb, new DoubleCollectionCell());
    }

    public static DoubleCollectionCell getRootAsDoubleCollectionCell(final ByteBuffer _bb,
        final DoubleCollectionCell obj) {
    ...
    public DoubleCollectionCell __assign(final int _i, final ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public double value(final int j) {
    ...
    public static int createDoubleCollectionCell(final FlatBufferBuilder builder, final int valueOffset,
    ...
    public static void startDoubleCollectionCell(final FlatBufferBuilder builder) {
        builder.startObject(3);
    }
    ...
    public static int createValueVector(final FlatBufferBuilder builder, final double[] data) {

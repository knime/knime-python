...
public final class ByteCollectionCell extends Table {
  public static ByteCollectionCell getRootAsByteCollectionCell(final ByteBuffer _bb) { return getRootAsByteCollectionCell(_bb, new ByteCollectionCell()); }
  public static ByteCollectionCell getRootAsByteCollectionCell(final ByteBuffer _bb, final ByteCollectionCell obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(final int _i, final ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public ByteCollectionCell __assign(final int _i, final ByteBuffer _bb) { __init(_i, _bb); return this; }

  public ByteCell value(final int j) { return value(new ByteCell(), j); }
  public ByteCell value(final ByteCell obj, final int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static int createByteCollectionCell(final FlatBufferBuilder builder,
  ...
  public static void startByteCollectionCell(final FlatBufferBuilder builder) { builder.startObject(3); }
  ...
  public static int endByteCollectionCell(final FlatBufferBuilder builder) {

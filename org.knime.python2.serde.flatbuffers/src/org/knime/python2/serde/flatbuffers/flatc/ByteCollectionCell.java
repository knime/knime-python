...
public final class ByteCollectionCell extends Table {
    public static ByteCollectionCell getRootAsByteCollectionCell(final ByteBuffer _bb) {
        return getRootAsByteCollectionCell(_bb, new ByteCollectionCell());
    }

    public static ByteCollectionCell getRootAsByteCollectionCell(final ByteBuffer _bb, final ByteCollectionCell obj) {
    ...
    public ByteCollectionCell __assign(final int _i, final ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public ByteCell value(final int j) {
        return value(new ByteCell(), j);
    }

    public ByteCell value(final ByteCell obj, final int j) {
    ...
    public static int createByteCollectionCell(final FlatBufferBuilder builder, final int valueOffset,
    ...
    public static void startByteCollectionCell(final FlatBufferBuilder builder) {
        builder.startObject(3);
    }

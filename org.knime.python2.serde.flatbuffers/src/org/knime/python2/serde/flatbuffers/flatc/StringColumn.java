...
public final class StringColumn extends Table {
  public static StringColumn getRootAsStringColumn(final ByteBuffer _bb) { return getRootAsStringColumn(_bb, new StringColumn()); }
  public static StringColumn getRootAsStringColumn(final ByteBuffer _bb, final StringColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(final int _i, final ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public StringColumn __assign(final int _i, final ByteBuffer _bb) { __init(_i, _bb); return this; }

  public String values(final int j) { int o = __offset(4); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  ...
  public static int createStringColumn(final FlatBufferBuilder builder,
  ...
  public static void startStringColumn(final FlatBufferBuilder builder) { builder.startObject(2); }

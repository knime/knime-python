...
public final class StringColumn extends Table {
    ...
    public static StringColumn getRootAsStringColumn(final ByteBuffer _bb, final StringColumn obj) {
    ...
    public static int createStringColumn(final FlatBufferBuilder builder, final int valuesOffset,
    ...
    public static void startStringColumn(final FlatBufferBuilder builder) {
        builder.startObject(2);
    }

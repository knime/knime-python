...
public final class LongCollectionColumn extends Table {
  public static LongCollectionColumn getRootAsLongCollectionColumn(final ByteBuffer _bb) { return getRootAsLongCollectionColumn(_bb, new LongCollectionColumn()); }
  public static LongCollectionColumn getRootAsLongCollectionColumn(final ByteBuffer _bb, final LongCollectionColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(final int _i, final ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public LongCollectionColumn __assign(final int _i, final ByteBuffer _bb) { __init(_i, _bb); return this; }

  public LongCollectionCell values(final int j) { return values(new LongCollectionCell(), j); }
  public LongCollectionCell values(final LongCollectionCell obj, final int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static int createLongCollectionColumn(final FlatBufferBuilder builder,
  ...
  public static void startLongCollectionColumn(final FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endLongCollectionColumn(final FlatBufferBuilder builder) {

...
public final class DoubleCollectionColumn extends Table {
  public static DoubleCollectionColumn getRootAsDoubleCollectionColumn(final ByteBuffer _bb) { return getRootAsDoubleCollectionColumn(_bb, new DoubleCollectionColumn()); }
  public static DoubleCollectionColumn getRootAsDoubleCollectionColumn(final ByteBuffer _bb, final DoubleCollectionColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(final int _i, final ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public DoubleCollectionColumn __assign(final int _i, final ByteBuffer _bb) { __init(_i, _bb); return this; }

  public DoubleCollectionCell values(final int j) { return values(new DoubleCollectionCell(), j); }
  public DoubleCollectionCell values(final DoubleCollectionCell obj, final int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static int createDoubleCollectionColumn(final FlatBufferBuilder builder,
  ...
  public static void startDoubleCollectionColumn(final FlatBufferBuilder builder) { builder.startObject(2); }

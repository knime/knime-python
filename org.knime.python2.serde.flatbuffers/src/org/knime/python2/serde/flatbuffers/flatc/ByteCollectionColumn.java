...
public final class ByteCollectionColumn extends Table {
  public static ByteCollectionColumn getRootAsByteCollectionColumn(final ByteBuffer _bb) { return getRootAsByteCollectionColumn(_bb, new ByteCollectionColumn()); }
  public static ByteCollectionColumn getRootAsByteCollectionColumn(final ByteBuffer _bb, final ByteCollectionColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(final int _i, final ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public ByteCollectionColumn __assign(final int _i, final ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public ByteCollectionCell values(final int j) { return values(new ByteCollectionCell(), j); }
  public ByteCollectionCell values(final ByteCollectionCell obj, final int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static int createByteCollectionColumn(final FlatBufferBuilder builder,
  ...
  public static void startByteCollectionColumn(final FlatBufferBuilder builder) { builder.startObject(3); }

...
public final class BooleanCollectionColumn extends Table {
  public static BooleanCollectionColumn getRootAsBooleanCollectionColumn(final ByteBuffer _bb) { return getRootAsBooleanCollectionColumn(_bb, new BooleanCollectionColumn()); }
  public static BooleanCollectionColumn getRootAsBooleanCollectionColumn(final ByteBuffer _bb, final BooleanCollectionColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(final int _i, final ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public BooleanCollectionColumn __assign(final int _i, final ByteBuffer _bb) { __init(_i, _bb); return this; }

  public BooleanCollectionCell values(final int j) { return values(new BooleanCollectionCell(), j); }
  public BooleanCollectionCell values(final BooleanCollectionCell obj, final int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static int createBooleanCollectionColumn(final FlatBufferBuilder builder,
  ...
  public static void startBooleanCollectionColumn(final FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endBooleanCollectionColumn(final FlatBufferBuilder builder) {

...
public final class BooleanCollectionColumn extends Table {
    public static BooleanCollectionColumn getRootAsBooleanCollectionColumn(final ByteBuffer _bb) {
        return getRootAsBooleanCollectionColumn(_bb, new BooleanCollectionColumn());
    }

    public static BooleanCollectionColumn getRootAsBooleanCollectionColumn(final ByteBuffer _bb,
        final BooleanCollectionColumn obj) {
    ...
    public BooleanCollectionColumn __assign(final int _i, final ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public BooleanCollectionCell values(final int j) {
        return values(new BooleanCollectionCell(), j);
    }

    public BooleanCollectionCell values(final BooleanCollectionCell obj, final int j) {
    ...
    public static int createBooleanCollectionColumn(final FlatBufferBuilder builder, final int valuesOffset,
    ...
    public static void startBooleanCollectionColumn(final FlatBufferBuilder builder) {
        builder.startObject(2);
    }

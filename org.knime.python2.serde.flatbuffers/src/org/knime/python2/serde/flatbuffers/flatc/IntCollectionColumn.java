...
public final class IntCollectionColumn extends Table {
  public static IntCollectionColumn getRootAsIntCollectionColumn(final ByteBuffer _bb) { return getRootAsIntCollectionColumn(_bb, new IntCollectionColumn()); }
  public static IntCollectionColumn getRootAsIntCollectionColumn(final ByteBuffer _bb, final IntCollectionColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(final int _i, final ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public IntCollectionColumn __assign(final int _i, final ByteBuffer _bb) { __init(_i, _bb); return this; }

  public IntegerCollectionCell values(final int j) { return values(new IntegerCollectionCell(), j); }
  public IntegerCollectionCell values(final IntegerCollectionCell obj, final int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static int createIntCollectionColumn(final FlatBufferBuilder builder,
      final int valuesOffset,
      final int missingOffset) {
    builder.startObject(2);
    IntCollectionColumn.addMissing(builder, missingOffset);
    IntCollectionColumn.addValues(builder, valuesOffset);
    return IntCollectionColumn.endIntCollectionColumn(builder);
  }

  public static void startIntCollectionColumn(final FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endIntCollectionColumn(final FlatBufferBuilder builder) {

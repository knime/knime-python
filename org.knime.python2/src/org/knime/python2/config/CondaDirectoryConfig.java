 ...
 */
public final class CondaDirectoryConfig implements PythonConfig {
    ...
    public CondaDirectoryConfig() {
        this(getDefaultInstallationDirectory());
    }
    ...
    public CondaDirectoryConfig(final String defaultInstallationDirectory) {
        m_condaDirectory = new SettingsModelString(CFG_KEY_CONDA_DIRECTORY_PATH, defaultInstallationDirectory);
    }

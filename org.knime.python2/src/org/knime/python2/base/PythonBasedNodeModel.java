...
public abstract class PythonBasedNodeModel extends NodeModel {
    ...
    public PythonBasedNodeModel(final PortType[] inPortTypes, final PortType[] outPortTypes) {
    ...
    protected abstract void validateSettingsDerived(NodeSettingsRO settings) throws InvalidSettingsException;
    ...
    protected abstract void loadValidatedSettingsFromDerived(NodeSettingsRO settings) throws InvalidSettingsException;
}

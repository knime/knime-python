...
/**
 * Dialog component for selecting an executable for a specific python version. This python version may be selected as
 * the default one.
 *
...
public class PythonPathEditor extends Composite implements DefaultPythonVersionOption, ExecutableObservable {
    ...
    private final FileFieldEditor m_pathEditor;
    ...
    private final Button m_defaultBtn;
    ...
    public void updateDefaultPythonVersion(final DefaultPythonVersionOption option) {
        if (this == option) {
            ...
            final String txt = m_header.getText();

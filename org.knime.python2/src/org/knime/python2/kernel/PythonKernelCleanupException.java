 ...
 */
public class PythonKernelCleanupException extends IOException implements PythonException {

    private static final long serialVersionUID = 1L;

    private static String amendMessage(final String message) {
        if (Strings.isNullOrEmpty(message)) {
            return "An exception occured while cleaning up Python. See log for details.";
        } else {
            return message;
        }
    }

    public PythonKernelCleanupException(final String message) {

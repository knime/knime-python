...
/**
 * Note: we cannot test offline serialization here since the (de)serialization logic of the Flatbuffers serialization
 * library is no equivalent on the Java vs Python sides.
 *
 * @author Marcel Wiedenmann, KNIME GmbH, Konstanz, Germany
 * @author Christian Dietz, KNIME GmbH, Konstanz, Germany
 */
public final class FlatbuffersSerializationTest {
	 ...
	 */
	public FlatbuffersSerializationTest() {
		m_tester = new SerializationLibraryTester(FlatbuffersColumnSerializationFactory.class);
	}

...
public final class Python2ObjectWriterNodeFactory2 extends NodeFactory<PythonObjectWriterNodeModel2> {
    ...
    public PythonObjectWriterNodeModel2 createNodeModel() {
        return new PythonObjectWriterNodeModel2();
    }
    ...
    @Override
    public NodeView<PythonObjectWriterNodeModel2> createNodeView(final int viewIndex,
        final PythonObjectWriterNodeModel2 nodeModel) {
        if (viewIndex == 0) {

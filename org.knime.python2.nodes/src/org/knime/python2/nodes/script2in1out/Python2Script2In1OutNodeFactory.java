...
public class Python2Script2In1OutNodeFactory extends NodeFactory<PythonScript2In1OutNodeModel> {
     ...
     */
    @Override
    public NodeView<PythonScript2In1OutNodeModel> createNodeView(final int viewIndex,
        final PythonScript2In1OutNodeModel nodeModel) {
        if (viewIndex == 0) {
            return new ExtToolStdoutNodeView<PythonScript2In1OutNodeModel>(nodeModel);
        } else if (viewIndex == 1) {
            return new ExtToolStderrNodeView<PythonScript2In1OutNodeModel>(nodeModel);
        }
        return null;
    }

 ...
 */
final class InstallationStatusDisplayPanelWithWarning extends Composite {
    ...
    public InstallationStatusDisplayPanelWithWarning(final SettingsModelString infoMessageModel,
        ...
        // Warning label:
        final var warning = new Label(this, SWT.NONE);
        final var orange = new Color(parent.getDisplay(), 255, 165, 0);

...
/**
 * Copied from org.knime.python2.pref.
 *
 * Abstract base class for the preference pages of the KNIME Python integration.
 *
 * @author Marcel Wiedenmann, KNIME GmbH, Konstanz, Germany
 */
abstract class AbstractPythonPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
     ...
     */
    AbstractPythonPreferencePage(final PythonConfigStorage currentPreferences,

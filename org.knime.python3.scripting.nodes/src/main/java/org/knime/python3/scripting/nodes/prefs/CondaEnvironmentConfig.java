 ...
 */
final class CondaEnvironmentConfig extends AbstractPythonEnvironmentConfig {

    private final SettingsModelString m_environmentDirectory;

    private String m_legacyEnvironmentNameConfigKey;
     ...
     */
    public CondaEnvironmentConfig(final String environmentDirectoryConfigKey, //

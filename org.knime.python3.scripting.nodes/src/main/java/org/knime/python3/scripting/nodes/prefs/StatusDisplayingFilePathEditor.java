...
final class StatusDisplayingFilePathEditor extends Composite {
    ...
    public StatusDisplayingFilePathEditor(final SettingsModelString pathModel, final boolean isFilePathEditor,
        ...
        final StringButtonFieldEditor pathEditor = isFilePathEditor //
            ? new FileFieldEditor("org.knime.python2", editorLabel, this) //
            : new DirectoryFieldEditor("org.knime.python2", editorLabel, this);
    ...
    public void setDisplayAsDefault(final boolean setAsDefault) {
        final var defaultSuffix = " (Default)";
        final var oldHeaderText = m_header.getText();
        if (setAsDefault) {

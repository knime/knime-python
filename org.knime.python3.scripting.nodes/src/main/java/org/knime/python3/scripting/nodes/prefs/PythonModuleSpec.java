...
final class PythonModuleSpec {
    ...
    public PythonModuleSpec(final String name, final Version version) {
        m_name = requireNonNull(name);
        m_minVersion = requireNonNull(version);
        m_minInclusive = true;
    ...
    public PythonModuleSpec(final String name, final Version minVersion, final boolean minInclusive) {
        m_name = requireNonNull(name);
        m_minVersion = requireNonNull(minVersion);
    ...
    public PythonModuleSpec(final String name, final Version minVersion, final boolean minInclusive,
        ...
        m_minVersion = requireNonNull(minVersion);
        m_minInclusive = minInclusive;
        m_maxVersion = requireNonNull(maxVersion);
    ...
    /**
     * @return The exact version of the module, if specified. Refer to #getMinVersion() and #getMaxVersion() if a
     *         version range is specified instead.
     */
     ...
     *         is returned by both this method and #getMaxVersion().
     */
    ...
    /**
     * @return Whether the @link #getMinVersion() is inclusive or not, if specified. If the module has a specific
     *         version, an optional of {@code true} is returned by both this method and #getMaxInclusive().
     */
     ...
     *         is returned by both this method and #getMinVersion().
     */
    ...
    /**
     * @return Whether the #getMaxVersion() is inclusive or not, if specified. If the module has a specific version, an
     *         optional of {@code true} is returned by both this method and #getMinInclusive()}.
     */
    ...
    public String toString() {
        ...
        final var inclusive = "inclusive";
        final var exclusive = "exclusive";
        var stringRepresentation = m_name;

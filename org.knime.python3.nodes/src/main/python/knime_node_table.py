...
"""
Old-style import for the modern KNIME Python table interface.
...
import knime.api.table as _ktn

_Tabular = _ktn._Tabular
_TabularView = _ktn._TabularView
_backend = _ktn._backend

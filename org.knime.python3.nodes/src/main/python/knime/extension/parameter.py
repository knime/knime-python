...
class ParameterArray(_BaseParameter):
    ...
    def __init__(
        ...
        parameters : list, optional
            Initial list of parameters for the array. Pass the ParameterGroup defining the settings of each item, with each item being an instance of the ParameterGroup.
        """
        super().__init__(
            label,
            description,

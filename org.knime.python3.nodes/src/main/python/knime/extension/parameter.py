...
class EnumParameterOptions(Enum):
    ...
    def _generate_options_description(cls, docstring: str, visible_members=None):
        ...
        members_to_show = visible_members if visible_members is not None else cls._member_names_
...
class EnumParameter(_BaseMultiChoiceParameter):
    ...
    **Important:** Validation accepts any enum member regardless of filtering. This ensures that saved
    ...
    def __init__(
        ...
        description: Optional[str] = None,
        default_value: Union[
            str, EnumParameterOptions, DefaultValueProvider[Union[str, EnumParameterOptions]]
        ] = None,
    ...
    def _generate_description(self, visible_options=None):
        ...
        return self._enum._generate_options_description(self.__doc__, visible_member_names)
    ...
    def _extract_description(self, name, parent_scope: _Scope):
        ...
        visible_options = self._get_visible_options(None) if self._visible_choices else None
        return {"name": self._label, "description": self._generate_description(visible_options)}

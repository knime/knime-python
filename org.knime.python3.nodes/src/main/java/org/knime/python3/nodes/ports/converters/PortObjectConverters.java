...
import org.knime.python3.types.port.KnimeToPythonPortObjectConverter;
import org.knime.python3.types.port.PortObjectConversionContext;
import org.knime.python3.types.port.PythonToKnimePortObjectConverter;
...
public final class PortObjectConverters {
    ...
    public static final class TablePortObjectConverter
        ...
        @Override
        public PythonTablePortObject convert(final BufferedDataTable portObject,
            final PortObjectConversionContext context) {
            return new PythonTablePortObject(portObject, context.tableConverter());
        }

        @Override
        public BufferedDataTable convert(final PurePythonTablePortObject purePythonPortObject,
            final PortObjectConversionContext context) {
            try {
    ...
    public static final class PythonBinaryPortObjectConverter
        ...
        @Override
        public PythonBinaryPortObject convert(final PythonBinaryBlobFileStorePortObject binaryData,
            final PortObjectConversionContext context) {
            return new PythonBinaryPortObject(binaryData);
        }

        @Override
        public PythonBinaryBlobFileStorePortObject convert(final PurePythonBinaryPortObject purePythonPortObject,
            final PortObjectConversionContext context) {
            try {
    ...
    public static final class PythonConnectionPortObjectConverter
        ...
        @Override
        public PythonConnectionPortObject convert(final PythonTransientConnectionPortObject binaryData,
            final PortObjectConversionContext context) {
            return new PythonConnectionPortObject(binaryData);
        }

        @Override
        public PythonTransientConnectionPortObject convert(final PurePythonConnectionPortObject purePythonPortObject,
            final PortObjectConversionContext context) {
    ...
    public static final class ImagePortObjectConverter
        ...
        @Override
        public ImagePortObject convert(final PurePythonImagePortObject purePythonPortObject,
            final PortObjectConversionContext context) {
     ...
     */
    public static final class PythonCredentialPortObjectConverter
        implements KnimeToPythonPortObjectConverter<CredentialPortObject, PythonCredentialPortObject>,
        PythonToKnimePortObjectConverter<PurePythonCredentialPortObject, CredentialPortObject> {

        @Override
        public PythonCredentialPortObject convert(final CredentialPortObject portObject,
            final PortObjectConversionContext context) {
            return new PythonCredentialPortObject(portObject);
        }

        @Override
        public CredentialPortObject convert(final PurePythonCredentialPortObject purePythonPortObject,
            final PortObjectConversionContext context) {
            var spec = PythonCredentialPortObjectSpec.fromJsonString(purePythonPortObject.getSpec().toJsonString())
                .getPortObjectSpec();
    ...
    public static final class PythonWorkflowPortObjectConverter
        ...
        @Override
        public PythonWorkflowPortObject convert(final WorkflowPortObject workflow,
            final PortObjectConversionContext context) {
     ...
     */
    public static final class PythonHubAuthenticationPortObjectConverter implements
        KnimeToPythonPortObjectConverter<AbstractHubAuthenticationPortObject, PythonHubAuthenticationPortObject> {

        @Override
        public PythonHubAuthenticationPortObject convert(
            final AbstractHubAuthenticationPortObject credentialsPortObject,
            final PortObjectConversionContext context) {

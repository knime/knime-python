 ...
 *
 * History
 *   May 16, 2025 (Adrian Nembach, KNIME GmbH, Konstanz, Germany): created
 */
...
/**
 * Handles error messages from the {@link WorkflowSegmentExecutor}.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
public final class WorkflowSegmentExecutorErrorUtils {


    /**
     * @param result of
     *            {@link WorkflowSegmentExecutor#executeWorkflowAndCollectNodeMessages(PortObject[], ExecutionContext)}
     * @throws WorkflowExecutionException if at least one node in the workflow had an error
     */
    public static void throwIfError(final WorkflowSegmentExecutionResult result) {
    ...
    private static void throwErrorMessage(final WorkflowSegmentExecutionResult result) {
        var errorMessages =

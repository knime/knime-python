...
/**
 * Creates a new Python process for every requested proxy.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class FreshPythonProcessProxyProvider implements NodeProxyProvider {
    ...
    FreshPythonProcessProxyProvider(final PythonNodeClass nodeClass) {

 ...
 */
final class DelegatingTextSettingsDataService implements TextSettingsDataService {

    private final Supplier<CloseableNodeDialogProxy> m_proxyProvider;

    DelegatingTextSettingsDataService(final Supplier<CloseableNodeDialogProxy> proxyProvider) {

...
public abstract class SourceCodePanel extends JPanel {
    ...
    private static class StatusBar extends JPanel {
        ...
        StatusBar() {
            ...
            final Icon stopIcon = new ImageIcon(Activator.getFile("org.knime.python", "res/stop.gif").getAbsolutePath());
    ...
    public SourceCodePanel(final String syntaxStyle, final VariableNames variableNames) {
        ...
        final Icon clearIcon = new ImageIcon(Activator.getFile("org.knime.python", "res/clear.gif").getAbsolutePath());

...
_SQLINPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timezone', full_name='knime.SQLInput.timezone', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='jars', full_name='knime.SQLInput.jars', index=8,

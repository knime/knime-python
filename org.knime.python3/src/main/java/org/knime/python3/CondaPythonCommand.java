...
/**
 * Conda-specific implementation of {@link PythonProcessProvider}. Allows to build Python processes for a given Conda
...
public final class CondaPythonCommand extends AbstractCondaPythonCommand {
    ...
    /**
     * Constructs a {@link PythonProcessProvider} that describes a Python process that is run in the Conda environment

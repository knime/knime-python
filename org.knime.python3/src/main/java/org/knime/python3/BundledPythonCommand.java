...
/**
 * Conda-specific implementation of {@link PythonProcessProvider} that works with bundled Python environments. Allows to build
...
public final class BundledPythonCommand extends AbstractCondaPythonCommand {
    ...
    /**
     * Constructs a {@link PythonProcessProvider} that describes a Python process that is run in the bundled Conda environment
